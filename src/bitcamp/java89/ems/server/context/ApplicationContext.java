...
public class ApplicationContext {
  ...
  private static void findClasses(File dir, ArrayList<Class<?>> classList){
    if (!dir.isDirectory()) {
      return;
    }
  ...
  private static boolean isComponent(Class<?> c) {
    // @Component 애노테이션이 있다면 리턴 값은 null이 아니다.
    return c.getAnnotation(Component.class) != null;
  }

  private static Class<?> loadClass(File file) throws IOException, ClassNotFoundException {
